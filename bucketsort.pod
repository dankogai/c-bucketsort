...
=head2 FreeBSD-8-STABLE-amd64/Core i5-2400
...
=head2 Ubuntu 11.10 AMD64 / VMWare@iMac
  ...
  $ LC_ALL=C time -v sort 1e7.txt > /dev/null 
    Command being timed: "sort 1e7.txt"
    User time (seconds): 10.48
    System time (seconds): 0.34
    Percent of CPU this job got: 99%
    Elapsed (wall clock) time (h:mm:ss or m:ss): 0:10.84
    Average shared text size (kbytes): 0
    Average unshared data size (kbytes): 0
    Average stack size (kbytes): 0
    Average total size (kbytes): 0
    Maximum resident set size (kbytes): 1952464
    Average resident set size (kbytes): 0
    Major (requiring I/O) page faults: 0
    Minor (reclaiming a frame) page faults: 122227
    Voluntary context switches: 1
    Involuntary context switches: 31
    Swaps: 0
    File system inputs: 0
    File system outputs: 154088
